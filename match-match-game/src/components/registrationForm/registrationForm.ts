...
export class RegistrationForm extends BaseComponent {
  ...
  constructor() {
    ...
    `
    this.nameInput = new Input('label', ['input-label'], 'First Name', 'text', 'First Name', '/^[a-z \,\.\'-]+$/i', true, 30);
    this.surnameInput = new Input('label', ['input-label'], 'Last Name', 'text', 'Last Name', '/^[a-z \,\.\'-]+$/i', true, 30);
    this.emailInput = new Input('label', ['input-label'], 'Email', 'text', 'Email', '/^[a-z \,\.\'-]+$/i', true, 30);
